...
namespace SZMK
{
    public partial class AD_SettingsMails_F : Form
    {
        public AD_SettingsMails_F()
        {
            InitializeComponent();
        }
        ...
        private bool AddMail()
        {
            try
            {
                AD_RegistrationMail_F Dialog = new AD_RegistrationMail_F();
        ...
        private void MoreInfo_B_Click(object sender, EventArgs e)
        {
            try
            {
                if (Mails_DGV.CurrentCell.RowIndex >= 0)
                {
                    ...
                    AD_InformationMail_F Dialog = new AD_InformationMail_F();
        ...
        {
            AD_ServerMail_F Dialog = new AD_ServerMail_F();
